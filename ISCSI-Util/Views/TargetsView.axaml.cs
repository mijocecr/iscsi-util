    ...
    private Control CreateTargetCard(IscsiDestino destino)
{
    ...
    // ============================================================
    // SELECCIÓN DEL DESTINO (versión FINAL)
    // ============================================================

    border.PointerPressed += async (_, _) =>
    {
        // 🔥 Selección REAL por IQN
...
{
    Console.WriteLine("=== LoadTargetDetailsAsync ===");
